...
class SPVCNN101_cls(nn.Module):
    def __init__(self, **kwargs):
        ...
        self.stage2 = nn.Sequential(
            ...
            *make_layers(3, cs[2], cs[2], midcs[1], ks=3, stride=1, dilation=1)
        )

        self.stage3 = nn.Sequential(
            ResidualBlock(cs[2], cs[3], midcs[2], ks=3, stride=2, dilation=1),
            *make_layers(22, cs[3], cs[3], midcs[2], ks=3, stride=1, dilation=1)
        )
